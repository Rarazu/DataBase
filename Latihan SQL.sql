-- membuat database dengan nama rara_RPL_29
create database rara_RPL_29;
...
-- menambahkan kolom kkm pada 'mapel'
alter table mapel add kkm double;

-- mengubah kolom id_kelas menjadi kode_kelas pada tabel 'siswa'
alter table siswa change id_kelas kode_kelas varchar (20);

-- menghapus kolom id_guru pada tabel 'nilai'
alter table nilai drop id_guru;
...
-- case : menampilkan data kelas yg mengikuti mapel 'Kimia'
...
-- case : menampilkan nilai dibawah kkm pd pjrn matematika
select siswa.nis, mapel.nama_mapel, mapel.kkm, nilai.nilai
...
-- group by -> digunakan untuk mengelompokkan proses perhitungan dari fungsi agregat
-- case : menampilkan mapel beserta jumlah siswa yg nilainya dibawah kkm
...
-- case : menampilkan data siswa yg diajar oleh 'Bu Siti Kurniawati'
...
-- case : menampikan nilai rata-rata dari setiap pelajaram
