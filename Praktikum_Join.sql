...
-- case 2 : kelompokkan data mahasiswa yang tidak 
-- mengambil matakuliah berdasarkan jenis kelamin
...
-- case 3 : nim dan nama mahasiswa yang mengambil matakuliah 
...
-- case 4 : nim, nama, dan total sks yang diambil oleh mahasiswa, 
-- di mana total sksnya lebih dari 4 dan kurang dari 10
...
-- case 5 : Dapatkan data matakuliah yang tidak 
-- diambil oleh mahasiswa terdaftar
...
-- CASE 
-- Tampilkan Nomor dan mata kuliah yang pesertanya 
-- lebih dari 40 orang. 
...
--Tampilkan nip dan nama instruktur yang mengajar
...
-- Tampilkan Total jumlah total mahasiswa yang Diajar 
-- oleh 'Steve Wozniak' menggunakan JOIN.
...
-- CASE
-- Gabungkan kedua tabel itu menggunakan JOIN dan UNION 
